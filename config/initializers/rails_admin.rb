# RailsAdmin config file. Generated on March 22, 2013 00:01
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Railslolcatsapp', 'Admin']
  ...
  # config.excluded_models = ['Journal', 'Post', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Journal', 'Post', 'User']
